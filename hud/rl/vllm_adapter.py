...
class VLLMAdapter:
    ...
    def load_adapter(self, adapter_name: str, adapter_path: str, timeout: int = 30) -> bool:
        ...
        try:
            ...
            logger.info(f"[VLLMAdapter] Loaded adapter: {adapter_name}")
            return True
            
        except requests.exceptions.RequestException as e:
            logger.error(f"[VLLMAdapter] Failed to load adapter {adapter_name}: {e}")
            return False
    ...
    def unload_adapter(self, adapter_name: str) -> bool:
        ...
        try:
            ...
            logger.info(f"[VLLMAdapter] Unloaded adapter: {adapter_name}")
            return True
