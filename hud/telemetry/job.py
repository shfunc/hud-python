...
class Job:
    ...
    def __init__(self, job_id: str, name: str, metadata: dict[str, Any] | None = None):
        self.id = job_id
        self.name = name
...
@contextmanager
def job(name: str, metadata: Optional[dict[str, Any]] = None, job_id: Optional[str] = None):
...
def create_job(name: str, metadata: Optional[dict[str, Any]] = None) -> Job:
...
def job_decorator(name: Optional[str] = None, **metadata):
