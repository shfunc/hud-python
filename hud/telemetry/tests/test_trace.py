...
class TestTrace:
    ...
    def test_trace_basic(self, mock_get_ctx_task_id, mock_set_ctx_task_id, mock_ctx_flush, mock_submit_loop):
    ...
    @patch("hud.telemetry.context.set_current_task_run_id")
    @patch("hud.telemetry.context.get_current_task_run_id")
    def test_trace_with_name(self, mock_get_ctx_task_id, mock_set_ctx_task_id, mock_ctx_flush, mock_submit_loop):
    ...
    @patch("hud.telemetry.context.set_current_task_run_id")
    @patch("hud.telemetry.context.get_current_task_run_id")
    def test_trace_with_attributes(self, mock_get_ctx_task_id, mock_set_ctx_task_id, mock_ctx_flush, mock_submit_loop):
    ...
    def test_trace_with_mcp_calls(self, mock_export_telemetry_coro, mock_get_ctx_task_id, mock_set_ctx_task_id, mock_ctx_flush, mock_submit_loop):
    ...
    @patch("hud.telemetry.context.set_current_task_run_id")
    @patch("hud.telemetry.context.get_current_task_run_id")
    def test_trace_nested(self, mock_get_ctx_task_id, mock_set_ctx_task_id, mock_ctx_flush, mock_submit_loop):
        """Test nested traces."""
        mock_get_ctx_task_id.side_effect = [
            None,
            "fake_outer_id",
            "fake_inner_id",
            "fake_outer_id"
