...
class ResponseAgent:
    ...
    def __init__(self, api_key: str | None = None, model: str = "gpt-4o", system_prompt: str | None = None) -> None:
        """
        ...
        - STOP: If the agent indicates it has successfully completed a task or is stuck, struggling or says it cannot complete the task, even if phrased as a question
          like "I have entered the right values into this form. Would you like me to do anything else?"
          or "Here is the website. Is there any other information you need?" or if the agent has strongly determined it wants to stop the task like "The task is infeasible. Can I help you with something else?
