...
from hud.utils.mcp import patch_mcp_config, setup_hud_telemetry
...
class TestPatchMCPConfig:
    ...
    def test_patch_meta_for_all_servers(self):
        ...
        assert mcp_config["server1"]["meta"]["test_key"] == "test_value"
        assert mcp_config["server2"]["meta"]["test_key"] == "test_value"
