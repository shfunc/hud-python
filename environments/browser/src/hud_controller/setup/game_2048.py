...
async def game_2048_board(ctx: Context, board_size: int = 4, target_tile: int = 2048):
    ...
    try:
        ...
        return SetupResult(
            content=f"Failed to initialize game: {str(e)}",
            isError=True
        )
...
async def game_2048_set_board(ctx: Context, board: List[List[int]], score: int = 0, moves: int = 0):
    ...
    try:
        ...
        return SetupResult(
            content=f"Failed to set board: {str(e)}",
            isError=True
        )
...
async def game_2048_near_win(ctx: Context, target_tile: int = 2048):
    ...
    try:
        ...
        return SetupResult(
            content=f"Failed to set near-win board: {str(e)}",
            isError=True
        )
...
async def game_2048_navigate(ctx: Context, url: str = None):
    ...
    try:
        ...
        return SetupResult(
            content=f"Failed to navigate to 2048 game: {str(e)}",
            isError=True
        )
...
async def game_2048_reset(ctx: Context):
    ...
    try:
        ...
        return SetupResult(
            content=f"Failed to reset game: {str(e)}",
            isError=True
        )
...
async def game_2048_test_seed(ctx: Context):
    ...
    try:
        ...
        return SetupResult(
            content=f"Failed to seed test board: {str(e)}",
            isError=True
        )