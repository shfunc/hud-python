...
class ClickElementSetup(BaseSetup):
    ...
    async def __call__(self, context: Any, selector: str, timeout: int = 30000, **kwargs) -> SetupResult:
...
class TypeTextSetup(BaseSetup):
    ...
    async def __call__(self, context: Any, selector: str, text: str, clear_first: bool = False, **kwargs) -> SetupResult:
...
class WaitForElementSetup(BaseSetup):
    ...
    async def __call__(self, context: Any, selector: str, timeout: int = 30000, state: str = "visible", **kwargs) -> SetupResult:
