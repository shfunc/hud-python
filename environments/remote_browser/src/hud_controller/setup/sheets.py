...
@setup("sheets_from_xlsx", "Create a Google Sheet from an Excel file URL")
class SheetsFromXlsxSetup(BaseSetup):
...
@setup("sheets_from_bytes", "Create a Google Sheet from base64 encoded Excel bytes")
class SheetsFromBytesSetup(BaseSetup):
