...
@evaluator("todo_completed", app="todo", description="Check if expected number of todos are completed")
class TodoCompletedEvaluator:
    ...
    async def __call__(self, context, expected_count: int) -> Dict[str, Any]:
        ...
        try:
            ...
            reward = 1.0 if success else (completed_count / expected_count if expected_count > 0 else 0.0)
...
@evaluator("todo_completion_rate", app="todo", description="Check if todo completion rate meets minimum threshold")
...
@evaluator("composite_evaluate", app="todo", description="Composite evaluator with weighted sub-evaluations")
    ...
    async def __call__(self, context, evaluators: List[Dict]) -> Dict[str, Any]:
        ...
        try:
            ...
            for eval_spec in evaluators:
                ...
                sub_result = await context.execute_evaluation({"function": function_name, "args": args})
