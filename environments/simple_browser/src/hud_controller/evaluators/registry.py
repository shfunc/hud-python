...
class EvaluatorRegistry:
    ...
    def create_evaluator(spec: dict, context=None):
        ...
        if function_name not in EVALUATOR_REGISTRY:
            ...
            raise ValueError(
                f"Unknown evaluator function: '{function_name}'. "
    ...
    def get_all_evaluators() -> List[Dict[str, Any]]:
        ...
        for name, cls in EVALUATOR_REGISTRY.items():
            ...
            if hasattr(cls, '__call__'):
                ...
                evaluator_info["call_docstring"] = call_method.__doc__ or "No documentation available"
                evaluator_info["call_annotations"] = str(getattr(call_method, '__annotations__', {}))
    ...
    def to_json() -> str:
        ...
        data = {
            ...
            "apps": list(set(e.get("app") for e in EvaluatorRegistry.get_all_evaluators() if e.get("app"))),
