...
class SetupRegistry:
    ...
    @classmethod
    def create_setup(cls, setup_spec: Dict[str, Any], context: BrowserEnvironmentContext) -> Callable:
    ...
    def get_setup_schema(cls, setup_name: str) -> Dict[str, Any]:
        ...
        return {
            ...
            "call_method_doc": getattr(setup_class.__call__, '__doc__', None) if hasattr(setup_class, '__call__') else None
        }
