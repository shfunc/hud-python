...
1. Navigate to `hud.so/leaderboards/{dataset-name}`
   - Example: `hud.so/leaderboards/hud-evals/sheetbench-50`
...
<Step title="Navigate to Leaderboard">
  Go to `hud.so/leaderboards/{dataset-name}`
</Step>
...
<CardGroup cols={2}>
<Card title="SheetBench-50" href="https://hud.so/leaderboards/hud-evals/SheetBench-50">
  Spreadsheet manipulation and analysis tasks
</Card>

<Card title="OSWorld-Verified" href="https://hud.so/leaderboards/hud-evals/osworld-verified">
  Desktop automation in Ubuntu environment
</Card>

<Card title="2048 Puzzles" href="https://hud.so/leaderboards/hud-evals/2048-puzzles">
