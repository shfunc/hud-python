...
description: "Add HUD docs to your AI assistant for enhanced development"
---

Enhance your AI assistant with HUD documentation for accurate code generation and contextual help.
...
<Card title="Full Documentation" icon="file-lines" href="https://docs.hud.so/llms-full.txt">
