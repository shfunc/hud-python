...
Tracing in HUD SDK allows you to:

- Capture all MCP calls made during a specific code block
- Upload these traces to the HUD platform for analysis
- View detailed information about each call, including timing and payload data
- Associate traces with specific task runs
