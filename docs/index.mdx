---
title: "HUD - Evaluate, Build, Train"
description: "Improve tool use and computer use agents. Built on Model Context Protocol."
---
...
<Card title="Using an AI assistant?" icon="sparkles">
...
async def main():
    ...
    task = Task(
        ...
        setup_tool={"name": "setup", "arguments": {"name": "board", "board_size": 4}},
        evaluate_tool={"name": "evaluate", "arguments": {"name": "max_number", "target": 128}}
    )
...
<Card title="Discord" icon="discord" href="https://discord.gg/hud-evals">
  Join our community
</Card>
</CardGroup>
