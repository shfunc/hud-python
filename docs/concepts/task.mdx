...
| `envconfig` | Environment configuration containing: <br> - `EnvType`: either a dockerfile, "browser", or "qa" (question-answer) <br> - `EnvImpl`: either a URL to a zip file or the name of a Python package |
