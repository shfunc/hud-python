...
| `hud mcp` | Run hot-reload development proxy | `hud mcp . --build` |
...
```bash
# 1. Start development proxy
cd environments/my-env
hud mcp . --build

# 2. Add to Cursor (copy from output)
# 3. Edit src/ files - changes reload automatically!
