...
## Setup Functions (for `hud-browser` `env.reset()`)

| Function                     | Description                                                                 |
| ---------------------------- | --------------------------------------------------------------------------- |
| `goto(url)`                  | Navigates to a URL.                                                         |
| `load_html_content(html)`    | Loads static HTML content into the browser.                                 |
| `sheets_from_xlsx(url, name?)` | Downloads XLSX, converts to Google Sheet, and navigates to it.              |
